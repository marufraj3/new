...
<?php $__env->startSection('title', 'Cron Job ম্যানেজমেন্ট'); ?>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-lg-8 col-xl-7 mb-4">
            <div class="cron-card" id="card-job-<?php echo e($job->id); ?>">
                ...
                <div class="cron-header">
                    ...
                    <div class="flex-grow-1">
                        <h5 class="mb-1 font-weight-bold" style="font-size:16px;"><?php echo e($job->job_title); ?></h5>
                        <p class="mb-0 text-muted" style="font-size:12px;"><?php echo e($job->job_description); ?></p>
                    </div>
                    
                    <label class="switch mb-0" title="<?php echo e($job->is_enabled ? 'বন্ধ করুন' : 'চালু করুন'); ?>">
                        <input type="checkbox" class="toggle-cron"
                               data-id="<?php echo e($job->id); ?>"
                               <?php echo e($job->is_enabled ? 'checked' : ''); ?>>
                ...
                <div class="cron-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-4">
                            <div class="stat-box">
                                <div class="stat-num text-success" id="updated-<?php echo e($job->id); ?>"><?php echo e($job->last_updated_count ?? 0); ?></div>
                                <div class="stat-label">আপডেট হয়েছে</div>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="stat-box">
                                <div class="stat-num text-danger" id="failed-<?php echo e($job->id); ?>"><?php echo e($job->last_failed_count ?? 0); ?></div>
                                <div class="stat-label">ব্যর্থ হয়েছে</div>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="stat-box">
                                <div class="stat-num text-primary"><?php echo e($job->frequency_minutes); ?></div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-2">
                        <div>
                            ...
                            <strong style="font-size:13px;" id="last-run-at-<?php echo e($job->id); ?>">
                    ...
                    <div class="alert alert-light py-2 px-3 mb-3" id="result-text-<?php echo e($job->id); ?>" style="font-size:12px;border-radius:8px;">
                        <i class="fa fa-info-circle text-muted mr-1"></i>
                        <?php echo e($job->last_run_result); ?>

                    </div>
                    <?php else: ?>
                    <div id="result-text-<?php echo e($job->id); ?>" style="display:none;" class="alert alert-light py-2 px-3 mb-3" style="font-size:12px;border-radius:8px;"></div>
                    <?php endif; ?>
                    ...
                    <div class="row align-items-end">
                        <div class="col-sm-4 mb-3 mb-sm-0">
                            ...
                            <select class="freq-select w-100" id="freq-<?php echo e($job->id); ?>">
                        ...
                        <div class="col-sm-4 mb-3 mb-sm-0">
                            ...
                            <select class="freq-select w-100" id="limit-<?php echo e($job->id); ?>">
                ...
                <div class="cron-footer d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <span style="font-size:12px;color:#64748b;">
                        ...
                        প্রতি <strong id="freq-display-<?php echo e($job->id); ?>"><?php echo e($job->frequency_minutes >= 60 ? ($job->frequency_minutes/60).' ঘণ্টা' : $job->frequency_minutes.' মিনিট'); ?></strong> পর স্বয়ংক্রিয় রান
                    </span>
                    <button class="btn-run-now" id="btn-run-<?php echo e($job->id); ?>" data-id="<?php echo e($job->id); ?>">
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/creativedesignbd/myshop1.creativedesign.com.bd/resources/views/backEnd/cronjob/index.blade.php ENDPATH**/ ?>