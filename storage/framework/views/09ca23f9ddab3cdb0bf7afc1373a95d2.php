...
<?php $__env->startSection('page-title', 'Verification Center'); ?>
...
<div class="container-fluid px-0">
        ...
        <div class="kyc-status-card status-rejected">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <small class="text-danger"><?php echo e($vendor->verification_note ?? 'Documents did not match requirements.'); ?></small>
                </div>
            </div>
            <span class="badge bg-danger bg-opacity-10 text-danger px-3 py-2">Rejected</span>
        </div>
    <?php elseif($vendor->verification_status == 'pending'): ?>
    ...
    <form action="<?php echo e(route('vendor.verification.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="row g-4">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <label for="id_front" class="id-upload-wrapper">
                                    ...
                                    <img id="preview_front" src="<?php echo e($vendor->voter_id_front ? asset($vendor->voter_id_front) : ''); ?>" class="id-preview-img <?php echo e($vendor->voter_id_front ? 'active' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                ...
                                <label for="id_back" class="id-upload-wrapper">
                                    ...
                                    <img id="preview_back" src="<?php echo e($vendor->voter_id_back ? asset($vendor->voter_id_back) : ''); ?>" class="id-preview-img <?php echo e($vendor->voter_id_back ? 'active' : ''); ?>">
                                    <div class="btn-change-overlay"><i class="fas fa-pen"></i> Change</div>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="card-body p-4 d-flex flex-column">
                        ...
                        <div class="text-center py-3 flex-grow-1">
                            ...
                            <label for="self_photo" class="profile-upload-box mb-3">
                                ...
                                <img id="preview_self" src="<?php echo e($vendor->self_image ? asset($vendor->self_image) : ''); ?>" class="id-preview-img <?php echo e($vendor->self_image ? 'active' : ''); ?>">
                            </label>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('vendor.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/creativedesignbd/myshop1.creativedesign.com.bd/resources/views/vendor/verification/index.blade.php ENDPATH**/ ?>