...
unset($__errorArgs, $__bag); ?>" 
                                   name="api_key" value="<?php echo e($steadfast->api_key); ?>" required />
...
unset($__errorArgs, $__bag); ?>" 
                                   name="secret_key" value="<?php echo e($steadfast->secret_key); ?>" required />
                    ...
                    <form action="<?php echo e(route('courierapi.update')); ?>" method="POST" data-parsley-validate>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="url" id="redx_url" required>
                                <option value="sandbox.redx.com.bd/v1.0.0-beta" <?php echo e($currentUrlNormalized == 'sandbox.redx.com.bd/v1.0.0-beta' || strpos($currentUrlNormalized, 'sandbox.redx.com.bd') !== false ? 'selected' : ''); ?>>Sandbox (Testing)</option>
                                <option value="openapi.redx.com.bd/v1.0.0-beta" <?php echo e($currentUrlNormalized == 'openapi.redx.com.bd/v1.0.0-beta' || strpos($currentUrlNormalized, 'openapi.redx.com.bd') !== false ? 'selected' : ''); ?>>Production (Live)</option>
                            </select>
                            <small class="text-muted">Select Sandbox for testing or Production for live operations</small>
                            <?php if(!empty($currentUrl)): ?>
                                <small class="text-info d-block mt-1">
                                    <i class="fe-info"></i> Current: <?php echo e($currentUrl); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">
                                <strong>Suggested URL:</strong> <code id="suggested_webhook_url"><?php echo e(config('app.url')); ?>/api/redx/webhook</code><br>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/creativedesignbd/myshop1.creativedesign.com.bd/resources/views/backEnd/apiintegration/courier_manage.blade.php ENDPATH**/ ?>