                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3 align-items-center">
                        ...
                        <div class="col-lg-4 col-md-5 mt-2 mt-md-0">
                            <form method="GET" action="<?php echo e(route('inhouse.products.index')); ?>">
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="product-title"><?php echo e(Str::limit($value->name, 40)); ?></h5>
                                        <?php
                                            $isDigital = (isset($value->is_digital) && $value->is_digital) || (isset($value->product_type) && $value->product_type === 'digital');
                                        ?>
                                        <span class="badge <?php echo e($isDigital ? 'badge-soft-primary' : 'badge-soft-info'); ?> mt-1 font-size-10">
                                            <i class="<?php echo e($isDigital ? 'fe-file-text' : 'fe-box'); ?> me-1"></i><?php echo e($isDigital ? 'Digital' : 'Physical'); ?>

                                        </span>
                                    </td>

                                    <td>
                                        <p class="m-0 fw-bold text-muted font-size-12"><?php echo e($value->category ? $value->category->name : 'Uncategorized'); ?></p>
                                    </td>

                                    <td>
                                        <div class="fw-bold text-dark">৳<?php echo e(number_format($value->new_price, 2)); ?></div>
                                        <small class="text-muted text-small">Stock: <span class="<?php echo e($value->stock <= 5 ? 'text-danger fw-bold' : 'text-success'); ?>"><?php echo e($value->stock); ?></span></small>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-1">
                                            ...
                                            <a href="<?php echo e(route('products.edit',$value->id)); ?>" class="btn-action btn-edit" title="Edit">
                                                <i class="fe-edit"></i>
                                            </a>

                                            
                                            <form method="post" action="<?php echo e(route('products.destroy')); ?>" class="d-inline" onsubmit="return confirm('Are you sure?');">        
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" value="<?php echo e($value->id); ?>" name="hidden_id">
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/creativedesignbd/myshop1.creativedesign.com.bd/resources/views/backEnd/inhouse_product/index.blade.php ENDPATH**/ ?>